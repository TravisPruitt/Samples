...
///			  use are IMAGE_COMPOSITE, IMAGE_VID_STREAM and IMAGE_WSQ(M31x and V31x only). The dimensions and image format of the image returned
///           can be found by issuing a call to V100_Get_Config, and apply as follows:
///
///			  IMAGE_COMPOSITE
///
...
///			TRIGGER_FINGER_DETECT:  Arms the device trigger and starts finger detection mode. This mode is supported for M31x and V31x sensors only. 
...
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *    pointer to device handle
///  @param [in, out]  pCmd V100_LRING_API_TYPE *		  pointer to Command structure to be returned
///
///  @return V100_ERROR_CODE Refer to Error code documentation for detailed description of
///							 possible return values. GEN_OK indicates operation was successful
///
///  @remarks Returns current settings of USER controllable features. See V100_LRING_API_TYPE
...
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Get_LRing_Cmd(const V100_DEVICE_TRANSPORT_INFO *pDev, V100_LRING_API_TYPE* pCmd);
...
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *    pointer to device handle
///  @param [in, out]  pCmd V100_LRING_API_TYPE *				  pointer to Command structure
///
///  @return V100_ERROR_CODE Refer to Error code documentation for detailed description of
///							 possible return values. GEN_OK indicates operation was successful
///
///  @remarks Sets current settings of USER controllable features. See V100_LRING_API_TYPE
///			  for information on Command Structure
///
///  @see
///
///  @author www.lumidigm.com @date 6/12/2007
///////////////////////////////////////////////////////////////////////////////
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Set_LRing_Cmd(const V100_DEVICE_TRANSPORT_INFO *pDev, V100_LRING_API_TYPE* pCmd);
...
///			  OPTION_PD_LEVEL, OPTION_SET_TEMPLATE_MODE(M3xx) and OPTION_SET_WSQ_COMPRESSION_LEVEL(M31x and V31x only)
...
/*********************** V100_Update_PIC_Firmware ***********************/
///////////////////////////////////////////////////////////////////////////////
///  global public  V100_Update_PIC_Firmware
///  Allows user to update firmware on the unit
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *		pointer to device handle
///  @param [in, out]  pFirmwareStream uchar *						Firmware stream
...
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Update_PIC_Firmware(const V100_DEVICE_TRANSPORT_INFO *pDev, uchar* pFirmwareStream, uint nFWStreamSize);


/*********************** V100_Script_Write ***********************/
///////////////////////////////////////////////////////////////////////////////
///  global public  V100_Script_Write
///  Allows user to write an LED script file to the device
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *		pointer to device handle
///  @param [in, out]  pFileToWrite char *							LED script file to write
///  @param [in]       nFileNameSize uint							Size of LED script file in bytes
///
///  @return V100_ERROR_CODE Refer to Error code documentation for detailed description of
///							 possible return values. GEN_OK indicates operation was successful
///
...
///  @see None.
///
///  @author www.Lumidigm.com @date 7/31/2012
///////////////////////////////////////////////////////////////////////////////
// 
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Script_Write(const V100_DEVICE_TRANSPORT_INFO *pDev, char* pFileToWrite, uint nFileSize);


/*********************** V100_Script_Read ***********************/
///////////////////////////////////////////////////////////////////////////////
///  global public  V100_Script_Read
///  Allows user to read an LED script file from the device
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *		pointer to device handle
///  @param [in, out]  pFileToWrite char *							LED script file read
///  @param [in]       pFileNameSize uint *							Size of LED script file read, in bytes
///
///  @return V100_ERROR_CODE Refer to Error code documentation for detailed description of
///							 possible return values. GEN_OK indicates operation was successful
///
...
///////////////////////////////////////////////////////////////////////////////
// 
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Script_Read(const V100_DEVICE_TRANSPORT_INFO *pDev, char* pFileToWrite, uint* pFileSize);
...
///
///  @param [in]       pDev const V100_DEVICE_TRANSPORT_INFO *		pointer to device handle
///  @param [in, out]  pScriptName char *							LED script file to play
///  @param [in]       brightness									brightness at which to play the script
///
///  @return V100_ERROR_CODE Refer to Error code documentation for detailed description of
///							 possible return values. GEN_OK indicates operation was successful
///
...
///  @see None.
///
///  @author www.Lumidigm.com @date 8/3/2012
///////////////////////////////////////////////////////////////////////////////
 
VCOM_CORE_EXPORT V100_ERROR_CODE V100_Script_Play(const V100_DEVICE_TRANSPORT_INFO *pDev, 
									char* pScriptName, LED_BRIGHTNESS brightness = BRIGHTNESS_LEVEL_8);
...
///			  is no valid finger placement on device platen. This call is supported for M31x and V31x sensors only.
///
...
///			  platen before capturing next print. User is required to lift the finger after each capture during enrollment.
///
