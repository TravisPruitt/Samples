/**
    ...
    // TODO - change to log_ naming format
*/
...
#include <stdio.h>
typedef enum { LOG_LEVEL_OFF = 0, LOG_LEVEL_ERROR, LOG_LEVEL_WARN, LOG_LEVEL_INFO, LOG_LEVEL_DEBUG, LOG_LEVEL_TRAFFIC } LogLevel;
...
void logClose();
    ...
    #define LOG_TRAFFIC(format, ...) logPrintf(LOG_LEVEL_TRAFFIC, __FILE__, __LINE__, format, __VA_ARGS__)
    ...
    #define LOG_ERROR(format...)
#else
    #define LOG_TRAFFIC(format...) logPrintf(LOG_LEVEL_TRAFFIC, __FILE__, __LINE__, format)
