...
SRC_URI_overo = "git://www.sakoman.com/git/u-boot.git;branch=omap4-exp;protocol=git \
                 file://0001-uboot-overo-ubifs.patch \
                 file://0002-overo_zero_bootdelay.patch \
"
SRCREV_overo = "261733408a27d14590cf3ec6b596461808050e32"
PV_overo = "2010.12+${PR}+gitr${SRCREV}"

pkg_postinst_overo () {
    echo "Erasing flash on u-boot partition"
    flash_eraseall /dev/mtd1
    echo "Flashing u-boot update - ${PV}"
    nandwrite -a -p /dev/mtd1 /boot/${UBOOT_BINARY}
