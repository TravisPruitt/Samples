...
SRC_URI = "ftp://ftp.isc.org/isc/dhcp/dhcp-3.1-history/dhcp-${PV}.tar.gz \
	   ...
	   file://dhclient-enter-hooks file://dhclient-exit-hooks \
	   file://xbrc file://dhcp-3.1.2p2_linux_3.patch file://dhclient-debug \
	   file://read-only-fix.patch file://flush-leases file://reader-restart \
	   "
