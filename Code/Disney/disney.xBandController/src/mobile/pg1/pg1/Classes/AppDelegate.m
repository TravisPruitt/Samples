...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
	...
	[[NSUserDefaults standardUserDefaults] setObject:fullVersion forKey:@"version_preference"];
	
	// now if the default venue hasn't been set, it will be nil ... we want it to be "Magic Kingdom"
	NSString *venue = [[NSUserDefaults standardUserDefaults] objectForKey:@"venue"];
	if(venue == nil) {
		[[NSUserDefaults standardUserDefaults] setObject:@"Magic Kingdom" forKey:@"venue"];
	}
...
// only valid if pg1-Info.plist specifies a protocol to handle
