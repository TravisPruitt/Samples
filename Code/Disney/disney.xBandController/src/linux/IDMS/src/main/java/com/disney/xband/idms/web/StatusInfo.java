...
public class StatusInfo
{
	...
	public IDMSStatus getIDMSStatus()
	{
		IDMSStatus idmsStatus = new IDMSStatus();
		idmsStatus.setHostname(hostname);
		idmsStatus.setStartTime(startTime);
		idmsStatus.setStatus(connectionStatus.getStatus());
		idmsStatus.setStatusMessage(connectionStatus.getMessage());
		idmsStatus.setVersion(version);
		idmsStatus.setDatabaseURL(ConfigurationSettings.INSTANCE.getDatabaseURL());
		idmsStatus.setDatabaseUserName(ConfigurationSettings.INSTANCE.getDatabaseUser());
		idmsStatus.setDatabaseVersion(connectionStatus.getVersion());
		idmsStatus.setReadOnly(ConfigurationSettings.INSTANCE.isReadOnly());
		return idmsStatus;
	}
