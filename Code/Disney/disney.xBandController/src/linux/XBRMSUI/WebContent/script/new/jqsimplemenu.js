            ...
            return this.each(function () {
                ...
                $("li", menu).mouseenter(function () {
                    ...
                    if (isTopLevel) {
                        ...
                        $('>li ul', menu).removeAttr('style').css('display', 'none').slideUp(0);
                        $(this).prepend(box);
                            ...
                            if ($(this).parent().find('ul:first').length == 0) {
                                timeoutInterval = setTimeout(function () {
                                    box.stop(true, false).animate({ height: '+=5' }, 300, function () {
                                        box.parent().find('ul:first').removeAttr('style').css('display', 'block').css('top', box.height()).stop(true, false).slideDown(100);
                                    });
                                }, 10);
                            }
                            else {
