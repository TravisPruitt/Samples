...
<s:form id="schedulerItemAjaxForm" action="scheduleritemedit" theme="simple" method="post"><div>
	...
	<dl class="leftJustified topMargin">	
...
|___________ sec (0-59)"
	...
	<div class="right" style="width:100%;"> 
		...
		<s:if test="systemOnly == false && jobClassName == ''"><s:submit method="deleteItem" onclick="return confirmDeleteSchedulerTask();" style="float: left; color: red" value="Delete"/></s:if>			
	</div>
</div>
</s:form>
</td>
