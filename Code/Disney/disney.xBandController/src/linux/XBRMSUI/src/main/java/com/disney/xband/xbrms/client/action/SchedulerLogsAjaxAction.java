...
public class SchedulerLogsAjaxAction extends BaseAction implements Preparable {
	...
	public String execute() throws Exception 
	{
		...
		{			
			...
			if (itemKey != null && !itemKey.isEmpty())
				ret = client.getItemLogs(startDate, itemKey, serverUrl);
			else if (jobClassName != null && !jobClassName.isEmpty())
				ret = client.getLogs(startDate, jobClassName, serverUrl);
			else
				ret = client.getLogs(startDate, serverUrl);
