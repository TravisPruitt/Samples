...
public class GxpQueue 
{
	...
	private boolean bNumericBandId;
	private Metrics metrics;
	
	public GxpQueue(String sGXPURL, int cThreads, boolean bNumericBandId, Metrics metrics)
	{
