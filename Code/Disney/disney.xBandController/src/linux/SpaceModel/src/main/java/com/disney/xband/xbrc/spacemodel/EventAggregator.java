...
public class EventAggregator implements Comparator<XbrEvent>
{
	...
	{	
		...
		for (XbrEvent ev: alEvents)
		{
			...
			{
				logger.debug("**** Comparing band ids:  " + lsCur.getID() + " vs " + ev.getID());
				logger.debug("**** Comparing pnos:      " + lsCur.getPacketSequence() + " vs " + le.getPno());
				logger.debug("**** Comparing locations: " + lsCur.getLocationInfo().getName() + " vs " + sLocationNew);
			}
	...
	public int compare(XbrEvent arg0, XbrEvent arg1)
	{
		...
		if (ri0 == null || ri0.getLocation() == null ||
                ri1 == null || ri1.getLocation() == null)
			return d;
