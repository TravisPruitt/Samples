...
<bc:breadcrumbs var='c' status='s'>
    ...
    <li class="${cssClass}">
    	<s:if test='action.startsWith("home")'>
    		...
    		<ul>
               <li><a href="locationlistedit">Location Editor</a></li>
               <li><a href="showqueue">Marching Guests</a></li>
               <li><a href="attractionview">Facility View</a></li>
               <li><a href="attractionedit">Facility Designer</a></li>
          	</ul>
    	</s:if>
    	<s:elseif test='action.equals("locationlistedit")'>
    		<s:a href="%{#attr['url']}">${c.name}</s:a>
    		<ul>
               <li><a href="newlocation">Create Location</a></li>
               <li><a href="newreader">Create Reader</a></li>
          	</ul>
    	</s:elseif>
    	<s:else>
    		<s:a href="%{#attr['url']}">${c.name}</s:a>
