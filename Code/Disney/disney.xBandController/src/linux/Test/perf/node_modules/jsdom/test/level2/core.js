...
exports['attrgetownerelement'] = testcase({
  ...
  // Retrieve the default attribute defaultAttr and check its owner element.  Verify if the name the nodeName of the returned ownerElement is emp:employee.
  ...
  // Retrieve an element and its attributes.  Then remove the element and check the name of the ownerElement of attribute of the attribute "street".
  // @see http://www.w3.org/Bugs/Public/show_bug.cgi?id=259
...
exports['documentimportnode'] = testcase({
   ...
   *
   ...
   element node which is retrieved by its elementId="CANADA", into the another document.
   ...
   *
   ...
   Using the method importNode with deep=true, retrieve the entity refs present in the
...
exports['elementhasattributens'] = testcase({
   ...
   *
   ...
   Retrieve the first employee element node.  Invoke the hasAttributeNS method to check if it
...
exports['elementsetattributenodens'] = testcase({
   ...
   *
   ...
   Retrieve the street attribute from the second address element node.
   ...
   *
   ...
   Retrieve an attribute node of an existing element node.  Attempt to add it to an another
...
exports['elementsetattributens'] = testcase({
   ...
   *
   The method setAttributeNS adds a new attribute.
   Retrieve an existing element node with a default attribute node and
...
exports['namednodemapgetnameditemns'] = testcase({
  /**
   *
   Using the method getNamedItemNS, retrieve the entity "ent1" and notation "notation1"
   ...
   *
   ...
   Using the method getNamedItemNS, retrieve an attribute node having namespaceURI=http://www.nist.gov
   ...
   has been retrieved successfully by checking its nodeName atttribute.
   ...
   *
   ...
   namespace names and namespace prefixes to it.  Using the getNamedItemNS retrieve the second attribute node.
   Verify if the attr node has been retrieved successfully by checking its nodeName atttribute.
   ...
   *
   ...
   Retrieve the second address element node having localName=adrress.
   Create a new attribute node having the same name as an existing node but different namespaceURI
   and add it to this element.  Using the getNamedItemNS retrieve the newly created attribute
   node from a nodemap of attributes of the retrieve element node.
   Verify if the attr node has been retrieved successfully by checking its nodeName atttribute.
  ...
  /**
   *
   Retrieve the second address element node having localName=adrress.  Retrieve the attributes
   of this element into 2 nodemaps.  Create a new attribute node and add it to this element.
   Since NamedNodeMaps are live each one should get updated, using the getNamedItemNS retrieve
...
exports['namednodemapremovenameditemns'] = testcase({
   ...
   *
   ...
   Retrieve an attribute node and then remove from the NamedNodeMap.  Verify if the attribute
   ...
   *
   ...
   Retrieve a default attribute node.  Remove it from the NodeMap.  Check if a new one immediately
  ...
  /**
   *
   Retrieve an entity and notation node and remove the first notation from the
   ...
   *
   ...
   Retrieve an attribute node into a namednodemap.  While removing it from the map specify
   ...
   *
   ...
   Retrieve an attribute node from a namednodemap.  While removing it from the map specify
   ...
   *
   ...
   Retrieve an attribute node from a namednodemap.  Remove the attribute node from the document
   ...
   *
   ...
   Retrieve an attribute node.  Remove the attribute node from the node map.
...
exports['namednodemapsetnameditemns'] = testcase({
   ...
   *
   ...
   Retrieve the first element whose localName is address and namespaceURI http://www.nist.gov",
   and put its attributes into a named node map.  Create a new attribute node and add it to this map.
   Verify if the attr node was successfully added by checking the nodeName of the retrieved atttribute.
   ...
   *
   ...
   the nodeName of the retrieved atttribute from the list of attribute nodes in this map.
   ...
   *
   ...
   Do the same for another document and retrieve its street attribute.  Call the setNamedItemNS
   using the first namedNodeMap and the retrieve street attribute of the second.  This should
  ...
  /**
   *
   Retrieve an entity and notation node and add the first notation to the
   ...
   *
   ...
   Retrieve the attribute whose namespaceURI=http://www.usa.com and localName=domestic
   ...
   attribute that was retrieved and removed from the first nodeMap as an argument.
...
exports['nodegetlocalname'] = testcase({
   ...
   *
   ...
   Retrieve the local part of their qualified names using getLocalName and verrify
   if it is correct.
   ...
   *
   ...
   Ceate two new element nodes and atribute nodes, with and without namespace prefixes.
   Retrieve their namespaceURI's using getNamespaceURI and verrify if it is correct.
   ...
   *
   ...
   Ceate two new element nodes and atribute nodes, with and without namespace prefixes.
   Retrieve the prefix part of their qualified names using getPrefix and verify
   if it is correct.
...
exports['nodehasattributes'] = testcase({
   ...
   *
   ...
   Retrieve an element node without attributes.  Verify if hasAttributes returns false.
   Retrieve another element node with attributes.  Verify if hasAttributes returns true.
   ...
   *
   ...
   Retrieve an element node with a default attributes.  Verify if hasAttributes returns true.
   ...
   *
   ...
   Element to the Document.  Retrieve the newly created element node from the document and check
...
exports['nodenormalize'] = testcase({
   ...
   *
   ...
   Retrieve the a default Attribute node which does not have a namespace prefix. Call the setPrefix
   ...
   *
   ...
   Retrieve an attribute node whose qualifiedName is xmlns.  Try setting a prefix on this node.
   Check if the NAMESPACE_ERR was thrown.
