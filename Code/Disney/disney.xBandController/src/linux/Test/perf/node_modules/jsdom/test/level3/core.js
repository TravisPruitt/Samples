...
exports.tests = {
   ...
   *
   ...
   Using getUserData with a junk value for the key attempt to retrieve the UserData object
   ...
   *
   Using isEqualNode check if 2 Attr nodes having the same nodeName and a null namespaceURI
   attribute, one created using createAttributeNS and the other retrieved from this document
   are equal.
