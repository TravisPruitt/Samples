	...
	function printNewQueue(q, l)
	{
		...
		if (q)
		{
			for(var i = 0; i < q.children.length; i++)
			{
				...
				{
					console.log(colors.dkgray + preString + colors.reset, colors.violet + q.children[i].commandName + d + " -> " + q.children[i].isDone);
				}
				else
				{
...
WebdriverJs.prototype.showTest = function(theTest, receivedValue, expectedValue, message)
{
	...
	{
		console.log('\n' + colors.red + "✖" + colors.reset + "\t" + message + "\t" + colors.white + expectedValue + colors.reset + " !== " + colors.red + receivedValue + colors.reset);
	}
};
