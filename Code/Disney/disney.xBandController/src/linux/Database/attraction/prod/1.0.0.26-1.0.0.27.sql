...
ALTER TABLE `Mayhem`.`VaLocationConfig` ADD COLUMN `vaTimeoutSec` INTEGER  NOT NULL DEFAULT 20 AFTER `carsPerTrain`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.27','attractionmodel');
