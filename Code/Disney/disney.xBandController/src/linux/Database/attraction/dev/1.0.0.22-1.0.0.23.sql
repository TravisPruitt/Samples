...
--
ALTER TABLE `Mayhem`.`Audit` MODIFY COLUMN `resourceId` VARCHAR(255)  CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.23','attractionmodel');
