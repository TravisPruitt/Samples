...
ALTER TABLE `Mayhem`.`StoredConfigurations` ADD COLUMN `internal` TINYINT  NOT NULL DEFAULT 0 AFTER `xml`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.15','attractionmodel');
