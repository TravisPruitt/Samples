...
ALTER TABLE `Mayhem`.`Reader` ADD COLUMN `lastReaderTestTime` BIGINT(20)  AFTER `transmitterHaPriority`,
 ADD COLUMN `lastReaderTestSuccess` TINYINT(1)  AFTER `lastReaderTestTime`,
 ADD COLUMN `lastReaderTestUser` VARCHAR(128)  AFTER `lastReaderTestSuccess`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.26','attractionmodel');
