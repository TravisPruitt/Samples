...
ALTER TABLE `Mayhem`.`EventsLocationConfig` ADD COLUMN `sendTapToHTTP` TINYINT(1)  NOT NULL DEFAULT 1 AFTER `sendDeltaConfToJMS`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.24','attractionmodel');
