...
ALTER TABLE `Mayhem`.`Audit` CHANGE COLUMN `description` `description` VARCHAR(2048) NULL DEFAULT NULL  , CHANGE COLUMN `resourceId` `resourceId` VARCHAR(512) NULL DEFAULT NULL  ;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.29','attractionmodel');
