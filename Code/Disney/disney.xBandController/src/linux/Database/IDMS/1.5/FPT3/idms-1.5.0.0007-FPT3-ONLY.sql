...
-- Description:	Handle transactional-guest-id
--              as Dreams ID for FPT3.
-- =============================================
...
BEGIN
	...
	BEGIN TRY
		...
		IF @sourceSystemIdType = 'transactional-guest-id'
		BEGIN
			SET @sourceSystemIdType = 'DreamsId'
		END
...
-- Updated By:	Ted Crane
-- Update Version: 1.0.5.0007
-- Description:	FPT3 Only always create xid.
-- =============================================
...
SELECT g.[guestId]
  ...
  where NOT EXISTS
  (SELECT 'X'
   FROM IDMS.dbo.source_system_link s
