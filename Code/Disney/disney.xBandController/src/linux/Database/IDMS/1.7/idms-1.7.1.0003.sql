...
/****** Object:  UserDefinedFunction [dbo].[ufn_StrIntToHex]    Script Date: 08/22/2013 10:59:27 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ufn_StrIntToHex]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[ufn_StrIntToHex]
GO
...
-- =============================================
CREATE FUNCTION [dbo].[ufn_StrIntToHex]
(
	@strInt NVARCHAR(200)
)
