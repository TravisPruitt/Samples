...
/****** Object:  Index [IX_Audit_DateTime]    Script Date: 06/05/2013 12:01:51 ******/
IF  EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[Audit]') AND name = N'IX_Audit_DateTime')
	ALTER TABLE [dbo].[Audit] DROP CONSTRAINT [IX_Audit_DateTime]
GO

CREATE NONCLUSTERED INDEX [IX_Audit_DateTime] ON [dbo].[Audit]
(
	[dateTime] ASC
