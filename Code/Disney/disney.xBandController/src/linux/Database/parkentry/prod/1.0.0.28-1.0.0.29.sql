...
--
-- Feature 6392. Cast member tap to open location.
--
ALTER TABLE `Mayhem`.`CastMember` ADD COLUMN `tapAction` VARCHAR(64)  NOT NULL DEFAULT "ClearBlueLane" AFTER `omniPassword`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.29','parkentrymodel');
