...
ALTER TABLE `Mayhem`.`CMST` MODIFY COLUMN `bandId` VARCHAR(32) DEFAULT NULL,
 MODIFY COLUMN `State` VARCHAR(32)  NOT NULL,
 ADD COLUMN `portalId` VARCHAR(64)  DEFAULT NULL AFTER `omniNumericId`;
...
INSERT INTO `SchemaVersion` VALUES ('1.0.0.8','parkentrymodel');
