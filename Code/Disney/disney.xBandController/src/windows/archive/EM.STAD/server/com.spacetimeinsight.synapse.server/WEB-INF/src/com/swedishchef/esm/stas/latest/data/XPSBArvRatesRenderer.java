...
public class XPSBArvRatesRenderer extends ChartDataXMLRenderer {
	...
	public Object render(Map params){
		...
		{	
			...
			if(queueArtifact.getLocation().equals(AttractionArtifact.SB_ARIVAL_RATE_COUNT) ||	queueArtifact.getLocation().equals(AttractionArtifact.XP_ARIVAL_RATE_COUNT))
			{
				//proceed 
